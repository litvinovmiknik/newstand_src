...
const spritesSvgWatch = config.src + '/images/sprites/svg/*.svg';
...
gulp.task('watch:spritesSvg', () => {
    gulp.watch(spritesSvgWatch, gulp.series('sprites:svg'))
        .on('all', (event, changed) => {
            state.watch.spritesSvg = changed;
        })
});
